...
const CandleChart = ({ buyCrypto }: any) => {
  ...
  return (
    <div className="border-[1px] border-neutral-20 mt-1 rounded-[16px]">
      <div className="flex flex-col md:flex-row items-center justify-between pb-6 pt-6">
        <p className="font-[500] text-neutral-100 text-base self-start pb-4 md:pb-0 md:text-[20px] ps-4">
          {buyCrypto.viewCurrentPriceCoins}
        </p>

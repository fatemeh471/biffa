...
function AboutCoin({ buyCrypto }: any) {
  ...
  const tabLinks = [
    ...
    { label: buyCrypto.deepMarket, link: '' },
  ...
  return (
    <>
      <h1 className="text-[44px] font-[700] text-center text-neutral-100">
        خرید بیت کوین
      </h1>

      <p className="text-neutral-99 text-[18px] text-center pt-[17px]">
        {buyCrypto.buyCheapSpotPrice}

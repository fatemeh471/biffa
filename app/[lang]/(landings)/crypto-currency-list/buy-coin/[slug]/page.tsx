...
const CoinPage = async ({
  ...
  const dictionary = await getDictionary(params.lang);
  const { buyCrypto, home, cryptoList } = dictionary;
  const item = [
    {
      answer: buyCrypto.answer,
      qustion: buyCrypto.question,
    },
    {
      answer: buyCrypto.answer,
      qustion: buyCrypto.question,
  ...
  return (
    <>
      <section className="bg-neutral-0 px-4 py-5 md:px-[80px] md:py-[64px]">
        <SectionCoinDetails buyCrypto={buyCrypto} />
      </section>
      <Content buyCrypto={buyCrypto} />
      ...
      <section className="px-4 md:px-[96px] mb-[36px] md:mb-[96px]">
        <ProfitableCurrencies buyCrypto={buyCrypto} />
      </section>
      <section className="px-4 md:px-[64px] pb-8 md:pb-[96px]">
